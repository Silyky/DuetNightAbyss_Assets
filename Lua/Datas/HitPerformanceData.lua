...
return ReadOnly("HitPerformanceData", {
  ...
  LightHit_100_F = {
    CauseHit = "LightHit",
    CauseHitParam = {
      MoveDis = 100, UseResourceDirection = "X"
    },
    HitFlyComboParam = {
      HitFlyXY = 400,
      HitFlyZ = 200,
