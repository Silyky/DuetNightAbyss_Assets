local T = {}
T.RT_1 = {SocketA = "root", SocketB = "hook_arm_r"}
T.RT_2 = {
  HandHold = {
...
T.RT_7 = {SocketA = "Root", SocketB = "hook_arm_r"}
T.RT_8 = {
...
return ReadOnly("BattleWeapon", {
  ...
  [20507] = {
    ...
    CRI = 0.22,
    FrontSight = {
      HideMagazineBar = true, SightUI = "Crossbow"
    },
    HelpAimDict = {
      GamePad = "OnlyOpenAim_01",
      Mobile = "OnlyOpenAim_01",
  ...
  Rate = "#1"
    ...
    CRD = 2,
    CRI = 0.19,
    FrontSight = {HeavyChargeId = 20601, SightUI = "Bow02"},
    MagazineCapacity = 1,
    MagazineUIType = "NoMagazine",
    MaxDistance = 4000,
    ModApplicationType = {
