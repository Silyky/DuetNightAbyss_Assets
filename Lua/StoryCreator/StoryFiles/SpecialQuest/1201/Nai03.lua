      ...
      questNodeData = {
        ...
        nodeData = {
          ...
          ["176543733256461290249"] = {
            ...
            type = "TalkNode",
            name = "对话节点",
            pos = {x = 5779.203824479975, y = -1014.5968713260802},
            propsData = {
              IsNpcNode = false,
          ...
          ["176543733256461290254"] = {
            ...
            pos = {x = 6301.087415743718, y = -944.6027775226199},
            propsData = {
              MessageId = 200038,
          ...
          ["176543733256461290256"] = {
            ...
            type = "UpdateTaskBarAndTaskMainNode",
            name = "更新任务目标节点",
            pos = {x = 5782.092529646798, y = -701.7810236367288},
            propsData = {
          ...
          ["176543733256461290259"] = {
            ...
            name = "显示图文引导",
            pos = {x = 5781.148097627888, y = -877.034274004925},
          ...
          ["17659645375891285304"] = {
            key = "17659645375891285304",
            type = "ShowGuideNode",
            name = "显示引导（支持执行操作后自动关闭/强制引导）",
            pos = {x = 6292.7609328017215, y = -799.6314502205977},
            propsData = {
              MessageId = 200038,
              SkillNameList = {"Skill3"},
              LastTime = -1,
          ...
          ["17659645683541285708"] = {
            key = "17659645683541285708",
            type = "PlatformJudgmentNode",
            name = "PC/手机平台判断",
            pos = {x = 6023.063968802861, y = -893.9967193919673},
            propsData = {}
          }
        },
        commentData = {
          ...
          ["176543737835561291520"] = {
            ...
            name = "Input Commment...",
            position = {x = 5714.99217902264, y = -1102.8965199830482},
            size = {width = 839.8899634015326, height = 558.8997951965594}
          },
      ...
      questNodeData = {
        ...
        nodeData = {
          ...
          ["17604287715923273921"] = {
            ...
            type = "ShowGuideNode",
            name = "显示引导（支持执行操作后自动关闭/强制引导）",
            pos = {x = 3186.220766699497, y = 447.3356419168623},
            propsData = {
              MessageId = 200038,
              SkillNameList = {"Skill3"},
              LastTime = -1,
          ...
          ["17659646855592565785"] = {
            key = "17659646855592565785",
            type = "ShowGuideNode",
            name = "显示引导（支持执行操作后自动关闭/强制引导）",
            pos = {x = 3200.1738925867326, y = 606.5205836459926},
            propsData = {
              MessageId = 200038,
              SkillNameList = {"Skill3"},
              LastTime = -1,
          ...
          ["17659647135192565977"] = {
            key = "17659647135192565977",
            type = "PlatformJudgmentNode",
            name = "PC/手机平台判断",
            pos = {x = 2891.1995442798147, y = 464.2128989626785},
            propsData = {}
          }
        },
        commentData = {
          ...
          ["176459288029612560745"] = {
            ...
            size = {width = 1718.555438635466, height = 885.495052975331}
          },
      ...
      questNodeData = {
        ...
        nodeData = {
          ...
          ["17604267649913564"] = {
            ...
            type = "ShowGuideNode",
            name = "显示引导（支持执行操作后自动关闭/强制引导）",
            pos = {x = 3272.676531675394, y = 525.8765989032995},
            propsData = {
              MessageId = 200038,
              SkillNameList = {"Skill3"},
              LastTime = -1,
          ...
          ["17659647616063206189"] = {
            key = "17659647616063206189",
            type = "PlatformJudgmentNode",
            name = "PC/手机平台判断",
            pos = {x = 2962.068975934706, y = 582.0000004384709},
            propsData = {}
          },
          ["17659647775633206591"] = {
            key = "17659647775633206591",
            type = "ShowGuideNode",
            name = "显示引导（支持执行操作后自动关闭/强制引导）",
            pos = {x = 3275.2343944158742, y = 678.3896353565442},
            propsData = {
              MessageId = 200038,
              SkillNameList = {"Skill3"},
              LastTime = -1,
